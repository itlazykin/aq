...
запросов и работы с хранимыми процедурами. Он эффективнее, так как не накладывает оверхед(дополнительные накладные расходы: Преобразование объектов в SQL-запросы и обратно,Кеширование и управление состоянием объектов,Генерация SQL,Рефлексия и прокси-объекты), характерный для ORM. Однако,
...
Например, DAO помогает мне разделить логику
